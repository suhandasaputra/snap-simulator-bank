...
import com.bopro.process.accountinquiryinternal;
 ...
 * @author suhan
 */
@WebServlet(name = "account_inquiry_internal", urlPatterns = {"/api/account/account_inquiry_internal"})
public class account_inquiry_internal extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(account_inquiry_internal.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new accountinquiryinternal().process(input);
