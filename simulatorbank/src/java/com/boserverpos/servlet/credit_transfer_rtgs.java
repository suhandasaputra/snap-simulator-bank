...
import com.bopro.process.credittransferinterbank;
import com.bopro.process.credittransferrtgs;
 ...
 * @author suhan
 */
@WebServlet(name = "credit_transfer_rtgs", urlPatterns = {"/api/transaction/credit_transfer_rtgs"})
public class credit_transfer_rtgs extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(credit_transfer_rtgs.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new credittransferrtgs().process(input);
