...
import com.bopro.process.balanceinquiry;
import com.bopro.process.bankstatement;
 ...
 * @author suhan
 */
@WebServlet(name = "bank_statement", urlPatterns = {"/api/bank_statement"})
public class bank_statement extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(bank_statement.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new bankstatement().process(input);
