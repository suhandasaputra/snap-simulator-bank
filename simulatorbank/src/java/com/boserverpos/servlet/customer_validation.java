...
import com.bopro.process.customervalidation;
 ...
 * @author suhan
 */
@WebServlet(name = "customer_validation", urlPatterns = {"/api/customer/customer_validation"})
public class customer_validation extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(customer_validation.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new customervalidation().process(input);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_validation.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
