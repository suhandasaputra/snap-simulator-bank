...
import com.bopro.process.bankcardtokenactivate;
 ...
 * @author suhan
 */
@WebServlet(name = "bank_card_token_activation", urlPatterns = {"/api/registration/bank_card_token_activation"})
public class bank_card_token_activate extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(bank_card_token_activate.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new bankcardtokenactivate().process(input);
