 ...
 * @author suhan
 */
@WebServlet(name = "credit_transfer_interbank", urlPatterns = {"/api/transaction/credit_transfer_interbank"})
public class credit_transfer_interbank extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(credit_transfer_interbank.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new credittransferinterbank().process(input);
