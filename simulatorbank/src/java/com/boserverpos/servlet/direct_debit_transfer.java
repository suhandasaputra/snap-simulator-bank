...
import com.bopro.process.directdebittransfer;
 ...
 * @author suhan
 */
@WebServlet(name = "direct_debit_transfer", urlPatterns = {"/api/transaction/direct_debit_transfer"})
public class direct_debit_transfer extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(direct_debit_transfer.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new directdebittransfer().process(input);
