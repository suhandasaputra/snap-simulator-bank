...
import com.bopro.process.credittransferskn;
 ...
 * @author suhan
 */
@WebServlet(name = "credit_transfer_skn", urlPatterns = {"/api/transaction/credit_transfer_skn"})
public class credit_transfer_skn extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(credit_transfer_skn.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new credittransferskn().process(input);
