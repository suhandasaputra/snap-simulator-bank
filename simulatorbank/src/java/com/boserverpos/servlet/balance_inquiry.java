 ...
 * @author suhan
 */
@WebServlet(name = "balance_inquiry", urlPatterns = {"/api/balance_inquiry"})
public class balance_inquiry extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(balance_inquiry.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new balanceinquiry().process(input);
