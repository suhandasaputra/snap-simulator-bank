...
import com.bopro.process.transactioninquiry;
 ...
 * @author suhan
 */
@WebServlet(name = "transaction_inquiry", urlPatterns = {"/api/transaction_inquiry"})
public class transaction_inquiry extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(transaction_inquiry.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new transactioninquiry().process(input);
