...
import com.bopro.process.cardregistration;
import com.bopro.process.cardunbinding;
 ...
 * @author suhan
 */
@WebServlet(name = "card_unbinding", urlPatterns = {"/api/registration/card_unbinding"})
public class card_unbinding extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(card_unbinding.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new cardunbinding().process(input);
