...
import com.bopro.process.accountinquiryeksternal;
 ...
 * @author suhan
 */
@WebServlet(name = "account_inquiry_eksternal", urlPatterns = {"/api/account/account_inquiry_eksternal"})
public class account_inquiry_eksternal extends HttpServlet {

//    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(account_inquiry_eksternal.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new accountinquiryeksternal().process(input);
