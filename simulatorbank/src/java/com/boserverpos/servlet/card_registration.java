 ...
 * @author suhan
 */
@WebServlet(name = "card_registration", urlPatterns = {"/api/registration/card_registration_create_token"})
public class card_registration extends HttpServlet {

    private MessageProcess mp = new MessageProcessImpl();
    private static Logger log = Logger.getLogger(card_registration.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            input = new cardregistration().process(input);
